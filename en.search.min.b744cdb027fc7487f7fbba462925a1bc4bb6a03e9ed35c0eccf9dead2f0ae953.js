...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.09d9c2f8a01bd2784e5a321833278068507da6b585b53522a5d47586d2f94ebb.js',function(){input.required=false;search();});}
